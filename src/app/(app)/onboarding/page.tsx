...
export const metadata: Metadata = {
  ...
  description: "Configura privacidade de áudio, idioma e integrações antes de usar o VoiceStream.",
  robots: {
    index: false,
    follow: false,
  },
  ...
  return (
    <div className="space-y-6">
      <header className="space-y-2">
        <h1 className="text-2xl font-bold tracking-tight">Bem-vindo ao VoiceStream</h1>
